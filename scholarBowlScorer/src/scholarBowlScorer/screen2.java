...
public class screen2 extends JFrame {
	...
	public JLabel[][] labels = new JLabel[32][19];
	...
	public void drawLabels(JLabel[][] l) {
		...
		l[2][9].setText("|A B+R|");
		l[2][10].setText(screen1.Players[6]);
		l[2][11].setText(screen1.Players[7]);
		l[2][12].setText(screen1.Players[8]);
		l[2][13].setText(screen1.Players[9]);
		l[2][14].setText(screen1.Players[10]);
		l[2][15].setText(screen1.Players[11]);
		l[2][16].setText("|B BONUS|");
		l[2][17].setText("|B RBND|");
		l[2][18].setText("|B B+R|");
		l[24][1].setText("QUESTIONS");
		l[24][2].setText(" ANSWERED");
		l[24][10].setText("QUESTIONS");
		l[24][11].setText(" ANSWERED");
		l[25][0].setText("10");
		l[26][0].setText("15");
		l[27][0].setText("-5");
		l[28][0].setText("0");
		//l[29][0].setText("SUBTOTALS");
		l[31][0].setText("TOTALS");
	...
	public void updateLabels(JLabel[][] l, double[][] s) {
		for (int i = 3; i < 23; i++) {
			...
			for (int j = 0; j < 2; j++) {
				...
				l[i][j + 16].setText(Double.toString(screen1.bonusArray[i - 3][j + 2]));
			}
			l[i][9].setText(Double.toString(screen1.bonusArray[i - 3][0] + screen1.bonusArray[i - 3][1]));
			l[i][18].setText(Double.toString(screen1.bonusArray[i - 3][2] + screen1.bonusArray[i - 3][3]));
			l[31][1].setText(Double.toString(screen1.scoresA));
			l[31][10].setText(Double.toString(screen1.scoresB));
